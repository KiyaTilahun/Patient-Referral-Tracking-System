        ...
        <ul class="space-y-2 font-medium">
            ...
            @if (auth()->user()->hasRole('superadmin'))
                <button type="button"
                    ...
                    <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="2" height="20"
                ...
                <ul id="rolemanage" class="hidden py-1 space-y-2 pl-6">
                    ...
                    <x-nav-link :href="route('department.add')" :active="request()->routeIs('department.add')" wire:navigate>
                        <div class="inline-flex">
                            ...
                            <span class="ms-3"> {{ __('Update Departments') }}</span>
                        </div>
                    </x-nav-link>
            ...
            @if (auth()->user()->hasRole('superadmin'))
                <x-nav-link :href="route('allreferrals')" :active="request()->routeIs('allreferrals')" wire:navigate>
                    <svg class="w-[20px] h-[20px] text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                    ...
                    <span class="ms-3"> {{ __('All Referrals') }}</span>
                </x-nav-link>
                ...
                <x-nav-link :href="route('departmentlist')" :active="request()->routeIs('departmentlist')" wire:navigate>
            ...
            <x-nav-link :href="route('editprofile')" :active="request()->routeIs(['editprofile'])" wire:navigate>
                ...
                <span class="ms-3"> Edit Your Profile</span>
            </x-nav-link>
            @endif
