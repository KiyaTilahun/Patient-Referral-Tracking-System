<div class="mx-auto grid grid-cols-12 gap-4  p-1">
            ...
            <x-breadcrumb> <li class="inline-flex items-center">
              ...
              <li aria-current="page">
                <div class="flex items-center">
                  ...
                  <span class="ms-1 text-sm font-medium  dark:text-white text-blue-600"> Department Services</span>
                </div>
              </li></x-breadcrumb>
              <x-page-heading :title="'Department Services'" />
    ...
    <div class="col-span-12 rounded-lg sm:col-span-7">
        ...
        <livewire:admin.department.service-table />
