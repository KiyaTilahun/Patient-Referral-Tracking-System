...
<div class="mx-auto grid grid-cols-12 gap-4  p-1">
    ...
    <div class="header col-span-12 rounded-lg bord py-8">
        <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-5xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Pending</span> Hospitals   </h1>
