<!-- sidenav  -->
  ...
  <aside class="hidden min-w-62.5 max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 md:block w-full flex-wrap items-center justify-between  rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 
    ...
    <div class="">
      ...
      <a class="block px-8 py-6 m-0 text-size-sm whitespace-nowrap text-slate-700" href="{{ url('') }}" target="_blank">
        ...
        <span
          class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} font-semibold transition-all duration-200 ease-nav-brand">PATIENT REFERRAL TRACKING</span>
      </a>
    </div>
